...
<template>
    ...
    <NavLink :href="route('citas')" :active="route().current('citas')" class="flex items-center text-pink-600 hover:text-pink-800">
        <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10m-10 4h10m-7 4h4m-9 4h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z" />
        </svg>
        Citas
    </NavLink>
    <NavLink :href="route('productos')" :active="route().current('productos')" class="flex items-center text-pink-600 hover:text-pink-800">
        <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    Estadísticas
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-pink-200 dark:hover:bg-gray-900 focus:outline-none focus:bg-pink-200 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out" @click="showingNavigationDropdown = ! showingNavigationDropdown">
                    <svg
                        class="h-6 w-6"
                        stroke="currentColor"
                        fill="none"
