                    ...
                    <div class="flex">
                        <div class="w-1/3"> <!-- Cambiado de w-1/2 a w-1/3 -->
                            ...
                            <form @submit.prevent="saveCita" class="space-y-6">
                                ...
                                <div>
                                    <button type="submit" class="w-full px-4 py-2 bg-indigo-600 text-white rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">{{ editingCita ? 'Actualizar' : 'Agregar' }}</button>
                                </div>
                            </form>
                        </div>
